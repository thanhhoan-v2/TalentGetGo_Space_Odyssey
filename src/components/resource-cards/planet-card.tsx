...
export default function PlanetCard({ planetName, imageUrl }: PlanetCardProps) {
  ...
  return (
    ...
    >
      <Link
        ...
        target="_blank"
        className="group block mx-auto w-[280px]"
      >
...
const planetData: Record<string, { image: string; searchUrl: string }> = {
  ...
  'Nal Hutta': {
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRla7dM1YPvqy7Om7PFZJoRvOvFy0tWeofSA&s',
